...
namespace imppsimpl
{
    ...
    */
      ...
      InputIterator last )
    {
      ...
      std::transform ( first,
                       last,
                       first,
                       std::bind2nd ( std::minus < value_type > ( ),
                                      stats.mean ));
      stats.std = std::sqrt (
    ...
    public:
      ...
      */
        ...
        OutputIterator result )
      {
        ...
        PolylineSimplification < DIM, InputIterator, value_type* >
          psimpl_to_array;
        ...
        if ( 1 < repeat )
        {
          ...
          PolylineSimplification < DIM, value_type*, value_type* >
            psimpl_arrays;
        ...
        PolylineSimplification < DIM, value_type*, OutputIterator >
          psimpl_from_array;
      ...
      */
        ...
        OutputIterator result )
      {
        ...
        InputIterator
          p1 = AdvanceCopy ( first ); // indicates the next point after p0
      ...
      */
        ...
        OutputIterator result )
      {
        diff_type coordCount = std::distance ( first, last );
        diff_type
          pointCount = DIM                    // protect against zero DIM
                       ? coordCount/DIM
                       : 0;
        value_type
          min_tol2 = min_tol*min_tol;    // squared minimum distance tolerance
        value_type
          max_tol2 = max_tol*max_tol;    // squared maximum distance tolerance

        // validate input and check if simplification required
        if ( coordCount%DIM || pointCount < 3 || min_tol2 == 0
          || max_tol2 == 0 )
        {
          return std::copy ( first, last, result );
        }
        ...
        InputIterator
          r0 = first;  // indicates the current key and start of the ray
      ...
      */
        ...
        OutputIterator result )
      {
        ...
        while ( moved )
        {
          ...
          {
            d2 = std::max ( d2,
                            math::segment_distance2 < DIM > ( current,
                                                              next,
                                                              p ));
            if ( tol2 < d2 )
            {
      ...
      */
        ...
        OutputIterator result )
      {
        ...
        util::scoped_array < value_type >
          reduced ( coordCount );   // radial distance results
        PolylineSimplification < DIM, InputIterator, value_type* >
          psimpl_to_array;
        ...
        util::scoped_array < unsigned char >
          keys ( pointCount );         // douglas-peucker results
        DPHelper::Approximate ( reduced.get ( ),
                                reducedCoordCount,
                                tol,
                                keys.get ( ));
      ...
      */
        ...
        OutputIterator result )
      {
        ...
        DPHelper::ApproximateN ( coords.get ( ),
                                 coordCount,
                                 count,
                                 keys.get ( ));
      ...
      */
      ...
      {
        diff_type
          original_coordCount = std::distance ( original_first, original_last );
      ...
      */
      ...
      {
        diff_type
          pointCount = std::distance ( original_first, original_last )/DIM;
        ...
        return math::compute_statistics ( errors.get ( ),
    ...
    private:
      ...
      */
      class DPHelper
      {
          ...
          struct SubPoly
          {
            SubPoly ( ptr_diff_type _first = 0, ptr_diff_type _last = 0 ):
          ...
          struct KeyInfo
          {
            KeyInfo ( ptr_diff_type _index = 0, value_type _dist2 = 0 ):
              index ( _index ), dist2 ( _dist2 ) {}
          ...
          struct SubPolyAlt
          {
            SubPolyAlt ( ptr_diff_type _first = 0, ptr_diff_type _last = 0 ):
              first ( _first ), last ( _last ) {}
        ...
        public:
          ...
          */
            ...
            unsigned char* keys )
          {
            ...
            Stack
              stack;                    // LIFO job-queue containing sub-polylines
        ...
        private:
          ...
          */
            ...
            ptr_diff_type last )
          {
            ...
            for ( ptr_diff_type current = first + DIM; current < last;
                  current += DIM )
            {
              value_type d2 =
                math::segment_distance2 < DIM > ( coords + first, coords + last,
                                                  coords + current );
              if ( d2 < keyInfo.dist2 )
              {
                continue;
  ...
  */
    ...
    bool* valid = 0 )
  {
    ...
    return ps.ComputePositionalErrorStatistics ( original_first,
                                                 original_last,
                                                 simplified_first,
                                                 simplified_last,
                                                 valid );
